    ...
    <div className="relative flex min-h-[30vh] items-start justify-start py-12 sm:py-6">
      <div className="relative z-10 text-start">
        ...
        <div className="mt-8 flex items-center justify-end">
          <Link
            href="/programs"
            className="group relative inline-flex items-center justify-center rounded-xl bg-accent/90 px-6 py-3 text-sm font-medium text-white transition-transform duration-200 hover:-translate-y-0.5 hover:bg-secondary hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
          >
